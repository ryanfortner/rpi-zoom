...
rm $HOME/.local/share/applications/zoom.desktop && rm $HOME/.local/share/applications/zupdate.desktop && rm $HOME/.config/autostart/zupdate.desktop || error "Failed to remove desktop shortcuts"
